...
const parseEmotes = require('../../../../src/chat/parse-msg/parse-tags/parse-emotes.js');

it('should return null', function () {
    assert.strictEqual(parseEmotes(null), null);
});

it('should return an emote', function () {
    assert.deepStrictEqual(parseEmotes('11:0-6'), [
        { id: 11, start: 0, end: 6, length: 6 }
    ]);
});

it('should return multiple places', function () {
    assert.deepStrictEqual(parseEmotes('11:0-6,9-13'), [
        { id: 11, start: 0, end: 6, length: 6 },
        { id: 11, start: 9, end: 13, length: 4 }
    ]);
});

it('should return multiple emotes', function () {
    assert.deepStrictEqual(parseEmotes('11:0-6/406:9-13'), [
        { id: 11, start: 0, end: 6, length: 6 },
        { id: 406, start: 9, end: 13, length: 4 }
    ]);
});

it('should return lots of emotes', function () {
    assert.deepStrictEqual(parseEmotes('171686:29-37,75-83,121-129,167-175/789949:0-3,46-49,92-95,138-141/839578:5-10,22-27,39-44,51-56,68-73,85-90,97-102,114-119,131-136,143-148,160-165,177-182/166449:12-20,58-66,104-112,150-158'), [
